...
import { ILaunchSettings, ILaunchType } from "@/interfaces/index.interface";
...
const validationSchema = Yup.object().shape({
  ...
  launchType: Yup.string().required("Launch Type is required"),
});
...
const LaunchSettings: FC = () => {
  ...
  const handleSubmit = (values: ILaunchSettings) => {
    const trimmedValues: ILaunchSettings = {
      ...
      launchType: values.launchType.trim() as ILaunchType,
    };
      ...
      >
        {({ errors, touched }) => (
          <Form className={styles.configSettingsInput}>
            ...
            <div className={styles.tokenInputWrapper}>
              <label className={styles.inputLabel}>Launch Type</label>
              <Field
                name="launchType"
                as="select"
                className={styles.tokenInput}
              >
                ...
                <option value={ILaunchType.LOCAL}>Local</option>
                <option value={ILaunchType.LIGHTNING}>Lightning</option>
              </Field>
              {errors.launchType && touched.launchType && (
                <div className={styles.errorMessage}>{errors.launchType}</div>
              )}
            </div>
